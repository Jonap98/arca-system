                            ...
                            <table id="paises" class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Tres</td>
                                        <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalEditarPais">
                                                Editar
                                            </button>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminarPais">
                                                Eliminar
                                            </button>
                                        </td>
                                    </tr>
